...
var wms_layer7 = L.tileLayer.wms(
  "https://portal.geopulsea.com/geoserver/PMC/wfs",
  {
    layers: "PMC:PMC_ward_rd",
    format: "image/png",
    transparent: true,
    version: "1.1.0",
    attribution: "PMC_ward_rd"
  }
);
...
var wms_layer6 = L.tileLayer.wms(
  "https://portal.geopulsea.com/geoserver/PMC/wfs",
  {
    layers: "PMC:PMC_ward_road_buffer1",
    format: "image/png",
    transparent: true,
    version: "1.1.0",
    attribution: "PMC_ward_road_buffer1"
  }
);
...
var wms_layer5 = L.tileLayer.wms(
  "https://portal.geopulsea.com/geoserver/PMC/wfs",
  {
    layers: "PMC:pune-electoral-wards",
    format: "image/png",
    transparent: true,
    version: "1.1.0",
    attribution: "electoral"
  }
);
...
var WMSlayers = {
  ...
  PMC_ward_rd:wms_layer7,
  PMC_ward_road_buffer1:wms_layer6,
...
$("#button").click(function () {
  ...
  $(document).ready(function () {
    $.ajax({
      type: "GET",
      url: "https://portal.geopulsea.com/geoserver/PMC/wfs?request=getCapabilities",
      dataType: "xml",
  ...
  $(function () {
    $("#layer").change(function () {
      ...
      $(document).ready(function () {
        $.ajax({
          type: "GET",
          url: "https://portal.geopulsea.com/geoserver/PMC/wfs?service=WFS&request=DescribeFeatureType&version=1.1.0&typeName=" +
            value_layer1,
          dataType: "xml",
  ...
  $(function () {
    $("#attributes").change(function () {
      ...
      $(document).ready(function () {
        $.ajax({
          type: "GET",
          url: "https://portal.geopulsea.com/geoserver/PMC/wfs?service=wfs&version=1.0.0&request=getfeature&typename=" +
...
$(function () {
  $("#selectvalue").change(function () {
    ...
    function fitbou(filter, layer1) {
      var urlm =
        "https://portal.geopulsea.com/geoserver/PMC/wfs?service=WFS&version=1.0.0&request=GetFeature&typeName=" +
